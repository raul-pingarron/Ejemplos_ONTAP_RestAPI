...
- Todo el tráfico entre el cliente y el LIF de ONTAP al que se conecta está encriptado (generalmente TLS, según la configuración de ONTAP).
- La conexión se puede realizar a través del Cluster Management LIF, o del Node Management LIF o incluso del SVM Management LIF.
